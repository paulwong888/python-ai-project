...
pipe = pipeline("text-generation", model="test-deeplearning/train_llm/02_prep_for_train/models/Llama3_Storyteller/merged", torch_dtype=torch.bfloat16, device_map="auto")
