...
def generate_script(subject, video_length, creatitity, api_key):
    ...
    model = ChatOpenAI(openai_api_key=api_key, temperature=creatitity)
    ...
    search_result = search.run(query=subject)
